...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
            ...
            //点击事件：点击订单详情按钮按oid查询订单详情（ajax动态请求数据）
                ...
                $.post(
					...
					function (data) {
						...
						for (var i = 0; i < data.length; i++) {
                            content += "<tr style='text-align: center;'><td><img src='${pageContext.request.contextPath}/"+data[i].pimage+"' width='70' height='60'></td>" +
