...
<head>
    ...
    <script type="text/javascript">
        ...
        function delProFromCart(key) {
            if (confirm("是否要删除该商品？")) {
                location.href = "${pageContext.request.contextPath}/product?method=delProFromCart&pid=" + key;
            }
        }

        function clearCart() {
            if (confirm("是否要清空当前购物车？")) {
                        ...
                        <tr class="active">
                            ...
                            <td>
                                <a href="javascript:void(0);" class="delete"
                                   onclick="delProFromCart('${entry.key}')">删除</a>
                            </td>
                        </tr>
